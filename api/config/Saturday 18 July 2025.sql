...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2025 at 09:40 PM
...
INSERT INTO `exams` (`exam_id`, `exam_code`, `title`, `description`, `department_id`, `program_id`, `level_id`, `semester_id`, `course_id`, `teacher_id`, `status`, `duration_minutes`, `pass_mark`, `total_marks`, `start_datetime`, `end_datetime`, `max_attempts`, `randomize`, `show_results`, `anti_cheating`, `created_at`, `approved_by`, `approved_at`) VALUES
(1, 'CS101-F24-MID', 'CS101 Midterm Exam', 'Midterm exam for Introduction to Programming', 1, 1, 100, 1, 1, 1, 'Completed', 60, 50.00, 100, '2024-11-01 10:00:00', '2024-11-01 11:00:00', 1, 1, 1, 1, '2025-07-07 10:52:23', 1, '2024-10-25 09:00:00'),
(2, 'EE201-F24-FINAL', 'EE201 Final Exam', 'Final exam for Circuit Analysis', 2, 2, 100, 1, 2, 2, 'Approved', 90, 60.00, 100, '2024-12-10 14:00:00', '2024-12-10 15:30:00', 1, 1, 1, 1, '2025-07-07 10:52:23', NULL, NULL),
(3, 'CS202-S25-QUIZ1', 'CS202 Quiz 1', 'First quiz for Data Structures', 1, 1, 100, 2, 3, 3, 'Approved', 30, 40.00, 50, '2025-03-05 09:00:00', '2025-03-05 09:30:00', 2, 1, 1, 0, '2025-07-07 10:52:23', 1, '2025-02-28 11:00:00'),
(4, '343', 'dadasa', 'wwsss', 1, 1, 200, 3, 3, 6, 'Approved', 120, 50.00, 100, '2025-07-19 18:24:00', '2025-07-19 20:24:00', 1, 1, 1, 1, '2025-07-15 18:27:37', NULL, NULL);
...
(6, 'adsklj', 'teacher@app.ems.com', '0541436414', 'micheal', 'Micheal', 'Adu', '$2y$12$FfBf6fShIjfJDcwx8Dz9LeOMJd2ALVBXTmHROHruaO6J4NZCrdwuy', 1, 'active', 0, '2025-07-08 16:15:59', '2025-07-17 18:42:02');
...
--
-- Structure for view `live_results` exported as a table
--
DROP TABLE IF EXISTS `live_results`;
CREATE TABLE`live_results`(
    `registration_id` int(11) NOT NULL,
    `total_questions` bigint(21) NOT NULL DEFAULT '0',
    `correct_answers` decimal(22,0) DEFAULT NULL,
    `incorrect_answers` decimal(22,0) DEFAULT NULL,
    `score_percentage` decimal(28,2) DEFAULT NULL
);
...
--
ALTER TABLE `choices`
  MODIFY `choice_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
ALTER TABLE `exams`
  ...
  ADD CONSTRAINT `exams_ibfk_7` FOREIGN KEY (`level_id`) REFERENCES `levels` (`level_id`);
