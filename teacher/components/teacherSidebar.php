...
/**
 * Renders the EMS Teacher sidebar navigation.
 *
 * @param string $currentPage The identifier of the current active page (e.g., 'dashboard', 'exams').
 */
function renderTeacherSidebar($currentPage)
{
    // Define menu items for teacher navigation
    $menuItems = [
        [
            'name' => 'Dashboard',
...
?>
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="fixed left-0 top-0 min-h-screen lg:h-screen h-[100dvh] w-64 bg-white shadow-sm z-100 flex flex-col overflow-y-auto transform transition-transform duration-300 ease-in-out lg:translate-x-0 -translate-x-full">
        <!-- Header -->
