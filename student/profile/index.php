        ...
        <div class="px-4 py-6 sm:px-6 lg:px-8 max-w-screen-2xl mx-auto">
            ...
            <div class="mb-4 md:flex md:items-center md:justify-between">
                <div class="flex-1 min-w-0">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Manage your account and personal information.</p>
                </div>
            </div>
            <div class="relative">
                <!-- Profile Card -->
                <div class="bg-white shadow-sm rounded-xl border border-gray-100 p-8 flex flex-col md:flex-row items-center gap-8">
                    <div class="flex flex-col items-center md:items-start md:w-1/3">
                        <div class="relative mb-4">
                            <img id="profileAvatar" src="https://ui-avatars.com/api/?name=Student" alt="Student Avatar" class="w-32 h-32 rounded-full border-4 border-emerald-300 shadow-lg object-cover" />
                        ...
                        <span class="inline-block px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 text-xs font-semibold mb-4"><i class="fa-solid fa-circle-check mr-1"></i> Active</span>
                        <button id="editBtn" class="bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-2 rounded-full font-semibold shadow transition-all duration-200 w-full mt-2">Edit Profile</button>
                    </div>
                    <div class="flex-1 flex flex-col gap-6 w-full">
                        <div id="viewDetails">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <h3 class="text-sm font-semibold text-emerald-700 mb-2 flex items-center gap-2"><i class="fa-solid fa-book mr-1"></i> Enrolled Courses</h3>
                                ...
                                <div>
                                    <h3 class="text-sm font-semibold text-emerald-700 mb-2 flex items-center gap-2"><i class="fa-solid fa-id-card mr-1"></i> Account Info</h3>
                                    <ul class="text-gray-700 text-base space-y-1">
                                        <li><span class="font-medium">Joined:</span> Jan 2024</li>
                                        <li><span class="font-medium">Status:</span> <span class="text-emerald-600 font-semibold">Active</span></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Divider -->
                        <div class="border-t border-emerald-100 my-4"></div>
                        <!-- Reset Password Section -->
                        <div class="mt-2">
                            <h3 class="text-lg font-semibold text-emerald-700 mb-2 flex items-center gap-2"><i class="fa-solid fa-key"></i> Reset Password</h3>
                            <form id="resetPasswordForm" class="space-y-4 max-w-md">
                                <div>
                                    <label class="block text-gray-700 mb-1">Phone Number</label>
                                    <input type="tel" id="resetPhone" required class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" placeholder="Enter your phone number">
                                </div>
                                <button type="button" id="sendOtpBtn" class="w-full bg-emerald-600 hover:bg-emerald-700 text-white py-2 rounded font-semibold">Send OTP</button>
                                <div id="otpSection" class="hidden">
                                    <label class="block text-gray-700 mb-1 mt-2">OTP</label>
                                    <input type="text" id="otpInput" maxlength="6" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" placeholder="Enter OTP">
                                    <label class="block text-gray-700 mb-1 mt-2">New Password</label>
                                    <input type="password" id="newPassword" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" placeholder="New Password">
                                    <button type="submit" class="w-full mt-4 bg-emerald-600 hover:bg-emerald-700 text-white py-2 rounded font-semibold">Reset Password</button>
                                </div>
                            </form>
                ...
                <div id="editModal" class="fixed inset-0 bg-black/40 z-50 flex items-center justify-center hidden transition-all duration-300">
                    <div class="bg-white rounded-xl shadow-2xl p-8 w-full max-w-2xl relative animate-fadeIn">
                        <button id="closeEditModal" class="absolute top-3 right-3 text-gray-400 hover:text-gray-700">
                            <i class="fa-solid fa-xmark fa-lg"></i>
                        </button>
                        <h2 class="text-xl font-bold text-emerald-700 mb-4 flex items-center gap-2"><i class="fa-solid fa-pen-to-square"></i> Edit Profile</h2>
                        <form id="editForm" class="space-y-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-gray-700 mb-1">Name</label>
                                    <input type="text" id="editName" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" required>
                                </div>
                                <div>
                                    <label class="block text-gray-700 mb-1">Email</label>
                                    <input type="email" id="editEmail" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" required>
                                </div>
                                <div>
                                    <label class="block text-gray-700 mb-1">Phone</label>
                                    <input type="tel" id="editPhone" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" required>
                                </div>
                                <div>
                                    <label class="block text-gray-700 mb-1">Enrolled Courses (comma separated)</label>
                                    <input type="text" id="editCourses" class="w-full px-3 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-emerald-400" required>
                                </div>
                            </div>
